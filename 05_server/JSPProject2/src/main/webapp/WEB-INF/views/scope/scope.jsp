...
<head>
    ...
    <title>Sevlet/JSP 내장 객체와 범위</title>
</head>
<body>

    <h1>Sevlet/JSP 내장 객체와 범위</h1>
    ...
    <pre>
        ...
        *****************************
        ...
        방법 1) \${ 범위이름Scope.속성명 }
                    ...
                    applicationScope
        방법2 ) \${ 속성명 }
                -> 각 범위에 세팅된 속성 중 속성명이 일치하는 경우 우선순위가 높은 scope의 속성 값이 얻어와짐
    </pre>
