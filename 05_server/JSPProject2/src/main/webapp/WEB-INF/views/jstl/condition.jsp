...
<body>
    ...
    <pre>
        ...
        *** 주의사항 ***
        1) test의 속성값은 무조건 EL구문으로 작성해야 함!!!!!!
        2) test의 속성값은 true 또는 false가 나오는 조건식이여야만 한다
        3) test의 속성값을 작성하는 ""내부에는 공백이 존재해서는 안된다.
    ...
    <c:if test="${name eq '홍길동'}" >
        <h3 style="color:blue">이름이 일치합니다.</h3>
    </c:if>
