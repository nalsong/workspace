...
// Servlet 관련 코드를 작성하기 위해서는 HttpServlet클래스 상속 받아야 한다!
// -> Tomcat에서 제공
...
public class ExampleController2 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//요청 시 전달된 input태그의 값(==parameter)을 얻어와 저장
		...
		// 옵션이 선택된 경우 출력
		// -> getParameter(), getParameterValues() 수행 시 전달된 값 중 name이 일치하는 값이 없으면 null반환
