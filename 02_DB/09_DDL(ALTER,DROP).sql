...
--> DEPT_ID, LOCATION_ID에만 NOT NULL제약조건 설정 됨
...
--ALTER TABLE DEPT_COPY ADD 
--CONSTRAINT CHK_DEPT_COPY CHECK(컬럼명 비교연산자 값);
ALTER TABLE DEPT_COPY ADD 
CONSTRAINT CHK_DEPT_COPY CHECK(LOCATION_ID IN ('L1', 'L2', 'L3', 'L4', 'L5' ));
...
-- ALTER 로 해봄
ALTER TABLE DEPT_COPY ADD 
NOT NULL DEPT_TITLE; -->안 됨

-- MODIFY 사용
ALTER TABLE DEPT_COPY MODIFY
DEPT_TITLE NOT NULL; -- ★NULL 관련 설정만 MODIFY사용!!(기억!)
---------------------------

-- DEPT_COPY에 추가한 제약조건 중 PK 빼고 모두 삭제

ALTER TABLE DEPT_COPY CONSTRAINT CHK_DEPT_COPY;
ALTER TABLE DEPT_COPY CONSTRAINT UK_DEPT_COPY;
ALTER TABLE DEPT_COPY CONSTRAINT SYS_C007510; --NOT NULL
--> NOT NULL 제약조건 ADD는 안되는데 DROP은 가능


-- NOT NULL 제거 시 MODIFY 사용
ALTER TABLE DEPT_COPY
MODIFY DEPT_TITLE CONSTRAINT SYS_C007510 /*NOT*/ NULL;
...
--> 이미 저장된 값이 수정하는 데이터 타입의 크기보다 크면 수정 불가!
-- 한글은 1글자에 3바이트
...
-- DEPT_COPY의 LNAME컬럼의 모든 값을 기본 값으로 수정
UPDATE DEPT_COPY
