...
public class VariableEx2 {
	...
	//main method : 자바코드 실행을 위한 구문
	public static void main(String[] args) {
		
	//System.out.println("확인"); //한 줄 출력
	//실행: ctrl + f11 또는 Run버튼 클릭
   ...
   //자료형 변수명
	...
	/*변수에 값 대입하기*/
	// -> 생성한 변수 값을 저장(대입)하는 것
	
	// 변수명 = 값;
	// =(등호)기호 : 대입 연산자(오른쪽 값을 왼쪽 변수에 저장)
...
//	ch = 'AA'; // char 자료형은 '' 안에 문자 하나만 작성 가능
	...
	// 왜 int와 동일할까?
	// -> byte, shout는 옛날 코드와의 호환을 위해 만들어진 자료형
	// --> 사용 빈도가 낮아서 별도의 리터널 표기법을 제작X
	// --> 임시로 int표기법을 사용
	
	
	long number3 = 10000000000L; //100억
	// L을 붙이지 않으면 int표기법으로 인식되어
	// 100억이 int로 해석되어짐
	// -> int의 범위 약 21억을 초과하여 오류 발생
	
	float number4 = 1.23f;
	// 1.23은 double의 표개법으로 인식되어
	//float형 변수에 저장할 수 없어 오류 발생
	// -> f를 붙여서 해결
