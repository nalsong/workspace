package edu.kh.polymorphiam.ex1.service;

import java.util.Scanner;

import edu.kh.polymorphiam.ex1.dto.Car;
import edu.kh.polymorphiam.ex1.dto.LightCar;
import edu.kh.polymorphiam.ex1.dto.Truck;

public class CarService {
	
	//다형성 : 객체가 다양한 형태를 지님
	// - 상속을 이용한 기술로 부모 타입의 참조변수 하나로 여러 타입의 자식 객체를 참조할 수 있다.
	...
	public void ex1() {
		...
		// c2의 자료형이 Car
		// -> Truck 객체를 참조하더라도 Car부분만 볼 수 있음!
...
//			printCar(Car객체 주소 또는 Car를 상속 받은 객체 주소);
	...
	public void printCar(Car c) {
		...
		// String edu.kh.polymorphiam.ex1.dto.Car.toString()
