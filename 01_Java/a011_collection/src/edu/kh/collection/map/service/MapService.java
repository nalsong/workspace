...
public class MapService {
	...
	public void ex1() {
		...
		// Set<T> keySet() : Key만 모아서 Set형태로 반환
...
//		Map<String, Object> member = new HashMap<>();
		...
		member.put("memberAge", 23); // Auto Boxing적용
		member.put("memberGender", 'M'); // Auto Boxing적용
		...
		//id, pw가 member와 모두 일치하면 member정보 출력
