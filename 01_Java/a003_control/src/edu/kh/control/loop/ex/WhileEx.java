...
public class WhileEx {
	...
	public void ex2() {
		...
		//input의 값은 while조건이 false가 되지 않는 값을 작성하며 된다!
		// -> 보통 자료형 범위의 중간 값인 0을 사용하고 이를 기본값이라 한다!
	...
	public void ex3() {
		...
		do { // 일단 1회 실행
			...
			sum += input;
			System.out.println("현재합계 : " + sum);
			
		} while(input !=0); // 0입력 시 종료
		System.out.println("최종결과 : " + sum);
