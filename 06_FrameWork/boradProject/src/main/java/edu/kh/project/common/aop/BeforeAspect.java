...
//	@Before("execution(* edu.kh.project..*Impl*.*(..))") //타겟 수행 전
	...
	@Order(1) // 순서, 하나의 타겟에 대한 여러 advice수행 시 순서 지정
	// 지정된 클래스. 메서드에 작성된 @Pointcut()어노테이션의 내용을 타겟으로 삼음
