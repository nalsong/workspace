...
INSERT INTO "MEMBER"
VALUES(SEQ_MEMBER_NO.NEXTVAL, 'user02@kh.or.kr', 'pass02!', '이번유저', '01043214321', '04540,,서울시 중구 남대문로 120,,2층', NULL, DEFAULT, DEFAULT, DEFAULT);
...
BEGIN
   FOR I IN 1..1500 LOOP
      ...
      VALUES( SEQ_BOARD_NO.NEXTVAL,
              ...
              DEFAULT, DEFAULT, DEFAULT, DEFAULT, 17, 
...
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00001.jpg', 'cat1.jpg', 0, 1491);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00002.jpg', 'cat2.jpg', 0, 1486);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00003.jpg', 'cat3.jpg', 0, 1484);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00004.jpg', 'cat4.jpg', 0, 1474);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00005.jpg', 'cat5.jpg', 0, 1471);
...
-- 게시글 좋아요 샘플 데이터 삽입
INSERT INTO "BOARD_LIKE" VALUES(1491, 7);
INSERT INTO "BOARD_LIKE" VALUES(1491, 17);
...
INSERT INTO BOARD_IMG 
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/', '20230508115013_00002.jpg', 'cat1.jpg', 1, 1491);

INSERT INTO BOARD_IMG 
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/', '20230508115013_00003.jpg', 'cat3.jpg', 2, 1491);
...
INSERT INTO "COMMENT"										--게시글 번호, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글1', DEFAULT, DEFAULT, 1508, 17, NULL);

INSERT INTO "COMMENT"										--게시글 번호, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글2', DEFAULT, DEFAULT, 1508, 17, NULL);




--1501 1502
INSERT INTO "COMMENT"										--게시글 번호, 회원, 부모댓글
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글1', DEFAULT, DEFAULT, 1508, 17, 1501);

INSERT INTO "COMMENT"										--게시글 번호, 회원, 부모댓글
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글1-2', DEFAULT, DEFAULT, 1508, 17, 1501);


INSERT INTO "COMMENT"										--게시글 번호, 회원, 부모댓글
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글1-3', DEFAULT, DEFAULT, 1508, 17, 1501);


INSERT INTO "COMMENT"										--게시글 번호, 회원, 부모댓글
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글2-1', DEFAULT, DEFAULT, 1508, 17, 1502);


INSERT INTO "COMMENT"										--게시글 번호, 회원, 부모댓글
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글2-2', DEFAULT, DEFAULT, 1508, 17, 1502);


INSERT INTO "COMMENT"										--게시글 번호, 회원, 부모댓글
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식의 자식 댓글2-1-1', DEFAULT, DEFAULT, 1508, 17, 1506);
...
-- 회원 프로필 이미지 변경
UPDATE "MEMBER" SET
PROFILE_IMG = '/resources/images/member/대장이.png'
WHERE MEMBER_NO = 17;
...
WHERE BOARD_NO = 1491 -- 게시글 번호
AND MEMBER_NO = 17 -- 로그인 회원 번호
;
...
-- 한 번에 여러 개 INSERT 하기(이미지 리스트(여러 개) 삽입)
...
FROM (
	SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
			0 IMG_ORDER, 1491 BOARD_NO
	FROM DUAL
	
	UNION ALL
	
	SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
			1 IMG_ORDER, 1491 BOARD_NO
	FROM DUAL
	
	UNION ALL
	
	SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
			2 IMG_ORDER, 1491 BOARD_NO
	FROM DUAL
)A;
