// innerText로 내용 읽어오기
function getBoxText(){
    // HTML 웹 문서 내에서 id 속성 값이 "test1"인 요소를 얻어와
    // test1변수에 대입
...
function getBoxElement(){
    //문서 내에서 아이디가 tes2인 요소를 얻어와 temp변수에 저장
    var temp = document.getElementById("test2");

    // temp요소에 작성된 태그, 속성, 내용을 얻어와 콘소에 출력
...
function add(){
    ...
    // 2) #area1 요소의 이전 내용에 새로운 내용(요소)를 추가
    // -> 이전 내용 + 새로운 내용 (누적)
