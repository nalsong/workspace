...
btn4.addEventListener("click", () => {
    // 1) div요소 만들기 -> 아직 화면에 추가는 되지 않은 상태!
    // 요소만 만들고 위치를 지정하지 않은 상태 
    const child = document.createElement("div");

    // 2) #area2에 마지막 자식으로 child 추가하기(덧붙이기)
    area2.appendChild(child);
