...
COMMENT ON COLUMN "BOARD"."BOARD_NO" IS '게시글번호(시퀀스 SEQ_BOARD_NO)';
...
CREATE TABLE "COMMENT" (
	...
	"COMMENT_COMMENT"	VARCHAR2(2000)	NOT NULL,
	"CREATE_FL"	DATE	DEFAULT SYSDATE	NULL,
	"DELETE_FL"	CHAR(1)	DEFAULT 'N'	CHECK("DELETE_FL" IN ('Y', 'N')),
	"MEMBER_NO"	NUMBER	NOT NULL 
...
COMMENT ON COLUMN "COMMENT"."COMMENT_COMMENT" IS '댓글내용';
COMMENT ON COLUMN "COMMENT"."CREATE_FL" IS '댓글작성일';
COMMENT ON COLUMN "COMMENT"."DELETE_FL" IS '삭제여부(Y/N)';
COMMENT ON COLUMN "COMMENT"."MEMBER_NO" IS '회원정보(FK)';
...
INSERT INTO "BOARD"
VALUES( SEQ_BOARD_NO.NEXTVAL, '샘플 제목 1', 
'내용1입니다\n안녕하세요', DEFAULT, DEFAULT, DEFAULT, 1);

INSERT INTO "BOARD"
VALUES( SEQ_BOARD_NO.NEXTVAL, '샘플 제목 2', 
'내용2입니다\n안녕하세요', DEFAULT, DEFAULT, DEFAULT, 1);

INSERT INTO "BOARD"
VALUES( SEQ_BOARD_NO.NEXTVAL, '샘플 제목 3', 
...
-- 조회수 증가(BOARD 테이블 READ_COUNT 컬럼값 수정)
UPDATE "BOARD"
SET READ_COUNT = READ_COUNT +1 --이전 조회수 +1값으로 수정
WHERE BOARD_NO = 1;
