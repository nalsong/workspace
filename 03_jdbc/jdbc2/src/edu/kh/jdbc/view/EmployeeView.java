...
public class EmployeeView {
	...
	private void selectName(){
		...
		// 입력 : 동
		// 200 / 선동일 / 대표 / 01099546325 / 총무부
		// 213 / 하동운 / 대리 / 01158456632 / 없음
		...
		try {
			...
			List<Employee> empList = service.selectName(inputName);
	...
	private void updateEmployee() {
		...
		// 입력 받은 값을 한 번에 전달하기 위한 Employee 객체 생성
