...
// JDBCTemplate에 있는 static메서드를 가져와 자신의 것처럼 사용
...
// Model : 데이버 논리 구조 제어(트랜잭션 제어), 데이터 가공 처리
// 			->(비즈니스 로직)
//
//		   DAO 수행 결과를 View/Controllor로 반환
...
public class EmployeeService {
	...
	public List<Employee> selectAll() throws SQLException{
		...
		// 1. 커넥션 생성
		// -> Service가 트랜잭션 제어 처리를 위해서는 Connection 객체가 Service에 존재해야 함
		// --> 만약 DAO에서 Connection을 만들고 반환하면 Service쪽에서 Connection을 사용할 수 없게 된다.
	...
	public List<Employee> selectName(String inputName) throws SQLException{
		...
		List<Employee> empList = dao.selectName(conn, inputName);
