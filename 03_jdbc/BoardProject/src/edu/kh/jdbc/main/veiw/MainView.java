...
import edu.kh.jdbc.board.veiw.BoardView;
...
public class MainView {
	...
	private void login() {
		...
		//서비스 호출 -> DAO 호출 -> SQLExction -> throws
		try {
	...
	private void signUp() {
		...
		try {
			...
			if(result > 0) { ///삽입성공
				...
				System.out.println("/n*** 회원 가입 실패 ***/n");
			}
