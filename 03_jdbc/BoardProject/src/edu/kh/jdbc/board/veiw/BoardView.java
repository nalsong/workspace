...
public class BoardView {
	...
	private void insertBoard() {
		...
		try{
			...
			//게시글 삽입 서비스 호출
			int result = boardService.insertBoard(boardTitle, sb.toString() , Session.loginMember.getMemberNo()); //(제목, 내용 , 로그인회원번호)
			...
			if(result >0) { //성공
				...
				System.out.println("게시글 등록 실패ㅜㅜ");
			}
